...
#math-problem(
  ...
  *Størrelse af vektorer*
  ...
  #note-box(
    ...
    Vi kan forestille os vektorerne som (geometriske) stedvektorer med begyndelsespunkt i $bold(0) = [0, 0, 0]^T$ og slutpunkt $bold(v)_i$ for hhv. $i = 1, 2, 3$.
  ]
]

#solution[

  For at finde længden af en vektor i $RR^3$ betragter vi normen af vektoren:

  $
  norm(bold(v_1)) &= sqrt((-10)^2 + (-10)^2 + (-10)^2) = #calc.norm(-10,-10,-10)  \
  norm(bold(v_2)) &= sqrt((-10)^2 + (-4)^2 + 14^2) = #calc.norm(-10,-4,14) \
  norm(bold(v_3)) &= sqrt((-10)^2 + (-8)^2 + (-12)^2) = #calc.norm(-10,-8,-12) 
$

  Her kan vi se at den længste vektor er $bold(v_2)$. For at finde hvilke vektorer er ortogonale finder vi dot produktet af to vektorer, hvis resultatet er nul så er de ortogonale. 

  $
    bold(v_1) dot bold(v_2) &= (-10) dot (-10) + (-10) dot (-4) + (-10) dot 14 = #((-10) * (-10) + (-10) * (-4) + (-10) * 14) \
    
    bold(v_1) dot bold(v_3) &= (-10) dot (-10) + (-10) dot (-8) + (-10) dot (-12) = #((-10) * (-10) + (-10) * (-8) + (-10) * (-12)) \
    bold(v_2) dot bold(v_3) &= (-10) dot (-10) + (-4) dot (-8) + 14 dot (-12) = #((-10) * (-10) + (-4) * (-8) + 14 * (-12))
  $

  Derfor kan vi se, at vektorerne $bold(v_1) "og" bold(v_2)$ er ortogonale. For at finde distancen mellem to vektorer finder vi normen af $bold(v) - bold(w)$:

  $
    norm(bold(v_1) - bold(v_2)) &= sqrt( ((-10) - (-10))^2 + ((-10) - (-4))^2 + ((-10) - 14)^2) \
    &= #calc.norm((-10) - (-10), (-10)-(-4), (-10)-14) \
    norm(bold(v_1) - bold(v_3)) &= sqrt( ((-10) - (-10))^2 + ((-10) - (-8))^2 + ((-10) - (-12))^2) \
    &= #calc.norm((-10) - (-10), (-10)-(-8), (-10)- (-12)) \
    norm(bold(v_2) - bold(v_3)) &= sqrt( ((-10) - (-10))^2 + ((-4) - (-8))^2 + (14 - (-12))^2) \
    &= #calc.norm((-10) - (-10), (-4)-(-8), 14- (-12)) \
  $

  Fra dette kan vi se at vektorerne $bold(v_1) "og" bold(v_3)$ er tættest
...
#math-problem(
  ...
  *Partielle afledede af simpel skalar-funktion*
...
#math-problem(number: "3")[
  *Forskellige(?) kvadratiske former*
...
#math-problem(
  ...
  *Kvadratiske former med symmetriske matricer*
